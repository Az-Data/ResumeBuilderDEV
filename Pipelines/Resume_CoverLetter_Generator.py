...
wh_roles = pd.read_csv("/notebooks/Inputs/WorkHistory_Roles.csv")
...
for job, folder in job_ads.items():
    ...
    wh_path =   f'/notebooks/Resume Components/{folder}/sorted_achievements.csv'
    ...
    document.save(f'/notebooks/Output/{folder}/Resume.docx')
